...
--|--|--
![light mode only](/assets/img/projects/face2.PNG){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }<figcaption style="text-align:center; font-size:0.9em;">웹페이지 구현도</figcaption>|![light mode only](/assets/img/projects/face2.PNG){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }<figcaption style="text-align:center; font-size:0.9em;">웹페이지 구현도</figcaption>|![light mode only](/assets/img/projects/face1.PNG){: .light .w-75 .shadow .rounded-10 w='1212' h='668'}<figcaption style="text-align:center; font-size:0.9em;">실제 구현된 웹페이지</figcaption>
![light mode only](/assets/img/projects/face2.PNG){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }<figcaption style="text-align:center; font-size:0.9em;">웹페이지 구현도</figcaption>|![light mode only](/assets/img/projects/face2.PNG){: .light .w-75 .shadow .rounded-10 w='1212' h='668' }<figcaption style="text-align:center; font-size:0.9em;">웹페이지 구현도</figcaption>|![light mode only](/assets/img/projects/face1.PNG){: .light .w-75 .shadow .rounded-10 w='1212' h='668'}<figcaption style="text-align:center; font-size:0.9em;">실제 구현된 웹페이지</figcaption>
