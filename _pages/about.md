...
profile:
  ...
  more_info: >
    ...
    <p class="aff">Graduate School of Soongsil University</p>
    <p class="bio">Research on hardware-efficient AI &amp; large vision-language models.</p>
    <p class="contact">Seoul, Republic of Korea</p>
    <p class="contact">dayoungkil (at) soongsil.ac.kr</p>
